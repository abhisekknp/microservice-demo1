...
import com.demo.microservices.auth.service.JdbcUserDetailsService;
...
public class OAuthServerConfiguration extends AuthorizationServerConfigurerAdapter {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2).select()
				.apis(RequestHandlerSelectors.basePackage("com.demo.microservices.auth")).paths(PathSelectors.any())
